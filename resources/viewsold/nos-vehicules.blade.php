          ...
          <tbody>
            @foreach ($vehicules as $item)
              <tr>
                  ...
                  <td>{{$item->numero_vehicule}}</td>
                  <td>{{$item->type_de_vehicule}}</td>
                  <td>{{number_format($item->nbre_de_place, 0, '', ' ')}}</td>
                  <td>
                      <a data-toggle="modal" data-target="#updateVehicule_{{$item->id}}" class="btn btn-warning">
                          <i class="fa fa-edit text-white"> Éditer</i>
                      </a>
                      <a data-toggle="modal" data-target="#deleteVehicule_{{$item->id}}" class="btn btn-danger">
