          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-warning text-black" style="color: black !important;">
                  <div class="inner">
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-success text-black" style="color: black !important;">
                  <div class="inner">
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-danger text-black" style="color: black !important;">
                  <div class="inner">
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-yellow" style="color: black !important;">
                  <div class="inner">
