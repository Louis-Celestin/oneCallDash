...
<div class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Rapport Journalier du  {{ session()->has('date') ? date('d-m-Y', strtotime(session()->get('date'))) : date('d-m-Y')}}</h1>
            </div>
        </div>
    </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{number_format($item->prix_depart, 0, '', ' ')." FCFA"}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
                    ...
                    <table id="example9" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{number_format($rapports->sum('prix_depart'), 0, '', ' ')." FCFA"}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
