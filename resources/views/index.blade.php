  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 px-2">
          <a href="{{route('report')}}" class="card-zo-link">
          ...
          <a href="{{route('activites-colis', ['gare_id' => '*', 'statut' => "all",'users_id'=>'*', 'date' => date("Y-m-d")])}}" class="card-zo-link">
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-5">
                      ...
                      <h2>{{number_format($colis->where('created_at','>=', date('Y-m-d'))->count(), 0, '', ' ')}}</h2>
                  </div>
      ...
      <div class="col-sm-4 px-2">
          <a href="{{route('activites-colis', ['gare_id' => '*', 'statut' => "Delivered",'users_id'=>'*', 'date' => date("Y-m-d")])}}" class="card-zo-link">
              <div class="card card-zo">
              <br>
              <div class="card-body"> 
                  <div class="row">
                  ...
                  <div class="col-md-5">
                      ...
                      <h2>{{$colis->where('statut', 'Delivered')->where('updated_at','>=', date('Y-m-d'))->count()}}</h2>
                  </div>
          ...
          <a href="{{route('vue-ensemble-colis')}}" class="card-zo-link">
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-8">
                      ...
                      <h2>{{number_format($colis->where('created_at','>=', date('Y-m-d'))->sum('prix'), 0, '', '.')}}</h2>
                  </div>
      ...
      <div class="col-sm-6 px-2">
        <a href="{{route('vue-ensemble-ticket')}}" class="card-zo-link">
            <div class="card card-zo">
            <br>
            <div class="card-body">
                <div class="row">
                ...
                <div class="col-md-8">
                    <h6 style="font-weight: bold;">TICKETS ENREGISTRES</h6>
                    <h2>{{number_format($ticket->where('created_at','>=', date('Y-m-d'))->count(), 0, '', '.')}}</h2>
                </div>
    ...
    <div class="col-sm-6 px-2">
      <a href="{{route('vue-ensemble-ticket')}}" class="card-zo-link">
          ...
          <div class="card-body">
              ...
              <div class="col-md-8">
                  <h6 style="font-weight: bold;">MONTANT ENREGISTRES</h6>
                  <h2>{{number_format($ticket->where('created_at','>=', date('Y-m-d'))->sum('prix'), 0, '', '.')}}</h2>
              </div>
