...
<div class="container-fluid">
  <div class="d-flex justify-content-between px-2">
    <h3>Rapport d'activités  {{($gares->where('id',$gare_id)[0]->nom_gare)}}</h3>
    ...
    <div class="col-sm-12">
        ...
        <div class="card my-2">
            <div class="card-body mx-auto">
                <form action="{{route('rapport-colis-search-gare')}}" method="post">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="users_id" id="" class="form-control">
                                        ...
                                        <option value="{{$agent->id}}" data-id="60">{{$agent->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
