...
<div class="container-fluid">
  ...
  {{--   {{ dd($colis->groupBy('gare_id_envoi')) }} 
    ...
    <div class="card">
        <div class="card-header">
            <strong>LISTE COLIS ENREGISTRES</strong>
        </div>
        <div class="card-body">
            <table class="table" id="example1">
                <thead>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                               {{-- <a class="btn btn-warning" data-toggle="modal" data-target="#exampleModal{{ $item[0]->gare_id_envoi }}"><i class="fa fa-eye"></i> Détail</a>--}}
                                <a href="{{route('activites-colis-gare',['gare_id' => $item[0]->gare_id_envoi, 'statut' => "all", 'date' => date('Y-m-d')])}}" class="btn btn-warning" ><i class="fa fa-eye"></i> Détail</a>
