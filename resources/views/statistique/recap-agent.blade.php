...
<div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{ route('stat.post_recap_agent') }}" method="post">
            @csrf
...
<div class="row my-2">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between my-2">
            <h3 class="card-title">STATISTIQUE  PAR NOMBRE DE GARE </h3>
  ...
  <div class="row my-2">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between my-2">
            <h3 class="card-title">STATISTIQUE DE RECETTE PAR BAGAGE  </h3>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
for ($i=0; $i < count($rapportGare) ; $i++) {
    $data[]=  array("label"=> $rapportGare[$i]->name, "y"=> $rapportGare[$i]->prix)  ;
    $databg[]=  array("label"=> $rapportGare[$i]->name, "y"=> $rapportGare[$i]->qte_bagage)  ;
};
//dd($data);
$dataPoints1  = ($data);
$dataPoints2  = ($databg);
