...
<div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{ route('stat.post_colis_recap_agent') }}" method="post">
            @csrf
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between my-2">
          <h3 class="card-title">RAPPORT RECAPITULATIF PAR GARE ET PAR AGENT</h3>
...
<div class="row my-2">
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between my-2">
            <h3 class="card-title">STATISTIQUE POUR :</h3>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
for ($i=0; $i < count($stat_colis) ; $i++) {
    $data[]=  array("label"=> $stat_colis[$i]->name, "y"=> $stat_colis[$i]->prix)  ;
    $databg[]=  array("label"=> $stat_colis[$i]->name, "y"=> $stat_colis[$i]->qte_colis)  ;
};
// dd($data);
$dataPoints1  = ($data);
$dataPoints2  = ($databg);
