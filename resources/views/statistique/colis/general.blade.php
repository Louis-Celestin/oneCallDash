...
<div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{ route('stat.colis_post_general') }}" method="post">
            @csrf
 ...
 {{-- <div class="col-lg-4 col-6">
    ...
    <div class="small-box bg-success" style="color: black !important;">
      <div class="inner">
        ...
        <h3>{{number_format($stat_colis->where('is_fret', 0)->sum('prix'), 0 , '', ' ')}}</h3>
  ...
  <div class="col-lg-4 col-6">
    ...
    <div class="small-box bg-warning" style="color: black !important;">
      <div class="inner">
        ...
        <h3>{{number_format($stat_colis->where('is_fret', 1)->sum('prix'), 0 , '', ' ')}}</h3>
  ...
  <div class="col-lg-4 col-6">
    ...
    <div class="small-box bg-danger" style="color: black !important;">
      <div class="inner">
        ...
        <h3>{{number_format($stat_colis->where('is_fret', 0)->sum('prix') + $stat_colis->where('is_fret', 1)->sum('prix'), 0 , '', ' ')}}</h3>
        ...
        <div class="card card-zo">
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-8">
                      <h6  style="font-weight: bold;">NOMBRE COLIS </h6>
                      <h5>{{$stat_colis->sum('qte_colis'). ""}}</h5>
      ...
      <div class="card card-zo">
          ...
          <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-8">
                    <h6  style="font-weight: bold;">MONTANT COLIS (FCFA) </h6>
                    <h5>{{number_format($stat_colis->sum('prix'), 0, '', ' ')}}</h5>
