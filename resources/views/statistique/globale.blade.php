...
<div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{ route('stat.post_globale') }}" method="post">
            @csrf
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between my-2">
          <h3 class="card-title">STATISTIQUE ANNUEL(S) PAR GARE OU/ET AGENT(S) </h3>
        </div>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
...
$dataPoints1 = array(
                            ...
                            array("label"=> $str_datetime11, "y"=> $stat_bagage11),
                            array("label"=> $str_datetime10, "y"=> $stat_bagage10),
                            array("label"=> $str_datetime9, "y"=> $stat_bagage9),
                            array("label"=> $str_datetime8, "y"=> $stat_bagage8),
                            array("label"=> $str_datetime7, "y"=> $stat_bagage7),
                            array("label"=> $str_datetime6, "y"=> $stat_bagage6),
                            array("label"=> $str_datetime5, "y"=> $stat_bagage5),
                            array("label"=> $str_datetime4, "y"=> $stat_bagage4),
                            array("label"=> $str_datetime3, "y"=> $stat_bagage3),
                            array("label"=> $str_datetime2, "y"=> $stat_bagage2),
                            array("label"=> $str_datetime1, "y"=> $stat_bagage1),
                            array("label"=> $str_datetime0, "y"=> $stat_bagage0)

);

$dataPoints2 = array(

                            array("label"=> $str_datetime11, "y"=> $stat_fret11),
                            array("label"=> $str_datetime10, "y"=> $stat_fret10),
                            array("label"=> $str_datetime9, "y"=> $stat_fret9),
                            array("label"=> $str_datetime8, "y"=> $stat_fret8),
                            array("label"=> $str_datetime7, "y"=> $stat_fret7),
                            array("label"=> $str_datetime6, "y"=> $stat_fret6),
                            array("label"=> $str_datetime5, "y"=> $stat_fret5),
                            array("label"=> $str_datetime4, "y"=> $stat_fret4),
                            array("label"=> $str_datetime3, "y"=> $stat_fret3),
                            array("label"=> $str_datetime2, "y"=> $stat_fret2),
                            array("label"=> $str_datetime1, "y"=> $stat_fret1),
                            array("label"=> $str_datetime0, "y"=> $stat_fret0)
