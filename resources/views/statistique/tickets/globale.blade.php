...
<div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{ route('stat.tickets_post_globale') }}" method="post">
            @csrf
...
$dataPoints1 = array(
                            ...
                            array("label"=> $str_datetime11, "y"=> $stat_tickets11),
                            array("label"=> $str_datetime10, "y"=> $stat_tickets10),
                            array("label"=> $str_datetime9, "y"=> $stat_tickets9),
                            array("label"=> $str_datetime8, "y"=> $stat_tickets8),
                            array("label"=> $str_datetime7, "y"=> $stat_tickets7),
                            array("label"=> $str_datetime6, "y"=> $stat_tickets6),
                            array("label"=> $str_datetime5, "y"=> $stat_tickets5),
                            array("label"=> $str_datetime4, "y"=> $stat_tickets4),
                            array("label"=> $str_datetime3, "y"=> $stat_tickets3),
                            array("label"=> $str_datetime2, "y"=> $stat_tickets2),
                            array("label"=> $str_datetime1, "y"=> $stat_tickets1),
                            array("label"=> $str_datetime10, "y"=> $stat_tickets0),
