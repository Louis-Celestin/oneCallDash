...
@section('title')
    Fiche suiveuse {{$nom_depart->nom_depart}} du {{session()->has('date') ? (session()->get('date')) : date('d-m-Y')}} |
@endsection
...
@section('content')
    <div class="content-header">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Fiche suiveuse {{$nom_depart->nom_depart}} du {{session()->has('date') ?  session()->get('date'): date('d-m-Y')}}</h1>
            </div>
        </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
