...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tickets {{$statut=='impaye'?'impayés':'payés'}}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Accueil</a></li>
            <li class="breadcrumb-item active">Tickets {{$statut=='impaye'?'impayés':'payés'}}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="card my-2">
    <div class="card-body mx-auto">
        <form action="{{route('informations-bagage-impayes-post', ['statut' => $statut] )}}" method="post">
            @csrf
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between my-2">
            <h3 class="card-title">LISTE DES TICKETS BAGAGES {{$statut=='impaye'?'IMPAYES':'PAYES'}} | TRANSPORTS SMT</h3>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
