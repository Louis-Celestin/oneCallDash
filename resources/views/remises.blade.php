  ...
  <div class="col-sm-4 px-2">
     ...
     <div class="card direct-chat direct-chat-primary ">
        <div class="card-header">
          <h3 class="card-title"><strong>Remise du jour</strong></h3>
     ...
     <div class="card direct-chat direct-chat-primary ">
      <div class="card-header">
        <h3 class="card-title"><strong>Remise par agent</strong></h3>
      </div>
      <!-- /.card-header -->
        <div class="card-body">
