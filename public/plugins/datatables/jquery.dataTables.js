...
(function( $, window, document, undefined ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( lang ) {
			...
			if ( ! lang.sEmptyTable && zeroRecords &&
				defaults.sEmptyTable === "il n'y a encore aucune donnée disponible dans cette table" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "il n'y a encore aucune donnée disponible dans cette table"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "il n'y a encore aucune donnée disponible dans cette table",
